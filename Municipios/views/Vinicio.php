...
<HTML>
<HEAD>
	<TITLE>Práctica 1 - Sesiones y AJAX</TITLE>
	<META charset="UTF-8">
...
<DIV class="container">
	...
	<DIV class="col col-md-12">
		<H2>Práctica 1 - Sesiones y AJAX</H2>
	</DIV>
	</DIV>
	...
	<DIV class="card card-default">
		...
		<DIV class="card-footer bg-secondary text-white">
			<A href="#" class="card-link text-white"
				data-toggle="modal" data-target="#modal-correo">Regístrese como nuevo usuario</A></DIV>
	</DIV>
	</DIV>
	</DIV>
